    ...
    public function retrieve($type, $id = "")
    {
        ...
        if ($type == "Request"){
            ...
            if ($id != ""){
                ...
                //         ->join('request', 'implantationpermit.request_no_request', '=', 'request.no_request')->where('request.no_request', '=', $id)
            ...
            // $CU = DB::table('request')->select('request.type_planningcertificate')->where('user_id_user', $this->user->id_user)->get();
            // $PC = DB::table('request')->select('request.type_buildingpermit')->where('user_id_user', $this->user->id_user)->get();
            // $PI = DB::table('request')->select('request.type_implantationpermit')->where('user_id_user', $this->user->id_user)->get();
            // $PD = DB::table('request')->select('request.type_demolitionpermit')->where('user_id_user', $this->user->id_user)->get();
            // $CC = DB::table('request')->select('request.type_certificateofconformity')->where('user_id_user', $this->user->id_user)->get();
            // $PL = DB::table('request')->select('request.type_autorizationtontosubdivide')->where('user_id_user', $this->user->id_user)->get();

            // if ($CU == 1){
            //     $RCU = DB::table('planningcertificate')->select('planningcertificate.*')->where('request_no_request', $result->no_request)->where('user_id_user', $this->user->id_user)->get();
            // }
            // else if ($PC === 1){
