...
class CreateBuildingpermitTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('buildingpermit', function (Blueprint $table) {
            $table->integer('id_buildingpermit', true);
            ...
            $table->tinyInteger('is_certificate_owernership_r')->nullable();
            $table->tinyInteger('is_descriptivequote_r')->nullable();
            $table->tinyInteger('is_groundplan_r')->nullable();
            $table->tinyInteger('is_sitesituationplan_r')->nullable();
    ...
    {
        Schema::dropIfExists('buildingpermit');
    }
}
